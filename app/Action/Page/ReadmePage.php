...
EXP;
    ...
    {
        return htmlspecialchars(file_get_contents(AppEnv::get('ROOT_PATH') . '/usage/SqlExplainProfilingAbstract.php'));
    }
    ...
    {
        return htmlspecialchars(file_get_contents(AppEnv::get('ROOT_PATH') . '/usage/MySqlExplainProfiling.php'));
    }
}
