CREATE TABLE `sql_detail` (
  ...
  `detail` text COLLATE utf8mb4_unicode_ci COMMENT 'sql profiling 详情',
  `explain` text COLLATE utf8mb4_unicode_ci COMMENT 'sql执行计划',
  PRIMARY KEY (`id`),
  UNIQUE KEY `sql_detail_s_id_uindex` (`s_id`),
  KEY `sql_detail_l_id_index` (`l_id`)
) ENGINE=InnoDB AUTO_INCREMENT=136268 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='sql运行详情表';
...
) ENGINE=InnoDB AUTO_INCREMENT=1177 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='请求信息表';
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='项目-模块关系表';